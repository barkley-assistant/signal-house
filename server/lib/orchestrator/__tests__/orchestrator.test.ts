  ...
  it('runs all configured collectors and merges data', async () => {
    ...
    sessionCollector.collect.mockResolvedValue({
      ...
      sessionUsage: {
        ...
        activeDays: 3,
        totalCost: 4.25,
        averageCostPerDay: 1.42,
        averageTokensPerSession: 120,
        medianTokensPerSession: 100,
        inputTokens: 70,
        outputTokens: 40,
        cacheReadTokens: 5,
        cacheWriteTokens: 2,
        uniqueTools: ['opencode'],
        toolUsage: [{ toolName: 'edit', count: 2, percentage: 66.7 }, { toolName: 'search', count: 1, percentage: 33.3 }],
  ...
  it('preserves sessionUsage when no GitHub collector configured', async () => {
    ...
    sessionCollector.collect.mockResolvedValue({
      ...
      sessionUsage: {
        ...
        activeDays: 2,
        totalCost: 1.25,
        averageCostPerDay: 0.63,
        averageTokensPerSession: 80,
        medianTokensPerSession: 75,
        inputTokens: 50,
        outputTokens: 20,
        cacheReadTokens: 4,
        cacheWriteTokens: 1,
        uniqueTools: ['opencode'],
        toolUsage: [{ toolName: 'edit', count: 1, percentage: 50 }, { toolName: 'search', count: 1, percentage: 50 }],
  ...
  it('preserves sessionUsage when only localGit and sessions configured', async () => {
    ...
    sessionCollector.collect.mockResolvedValue({
      ...
      sessionUsage: {
        ...
        activeDays: 1,
        totalCost: 0.5,
        averageCostPerDay: 0.5,
        averageTokensPerSession: 60,
        medianTokensPerSession: 60,
        inputTokens: 30,
        outputTokens: 10,
        cacheReadTokens: 0,
        cacheWriteTokens: 0,
        uniqueTools: ['opencode'],
        toolUsage: [{ toolName: 'edit', count: 1, percentage: 100 }],
